...
<div class="col-md-10 column" style="background-color:#fff;height:550px;">
    <div class="col-md-0">
     ...
     <div class="col-md-12" style="background-color:#fff;height:520px;border-radius:0px";>
        ...
        <form name="form2" method="get" action="">
            <table class="table  table-striped table-bordered table-hover"><br/>
                ...
                <div class="col-md-2 pull-right">
                    <input class="form-control" type="text" placeholder="专利名称" name="name"/>
                </div>
                <br/><br/>
...
<script>
 $(".delAll").click(function(){
    ...
    //alert(check);
    $.ajax({
        url:'/test/Hospitalsrms/index.php/Admin/Kytj/propty_delAll',
        type:'post',
        data:data,
        dataType:'JSON',
...
<div class="col-md-12 column" style="background-color:#fff;border:1px solid #4857bf;height:60px;text-align:center;">
