...
<body class="templatemo-bg-gray" style="background-image:url('/test/Hospitalsrms/Public//img/logback3.jpg');background-position:center; background-repeat:no-repeat">
	<div class="container">
		...
		<div class="col-md-5" >
			...
			<div style="width:410px;border:0px solid yellow;">
				...
				<div style="color:white;text-align:center;font-size:30px;border:0px solid #fff;height:200px;">
					<div>综合性<br/>医院科研管理系统后台系统<br/><hr></div>
				</div>
			</div></div>
				<div class="col-md-12" style="background-color:#fff;opacity:0.8;border:1px solid #e8e8e8;border-radius:6px;">
					...
					<form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="http://localhost/test/Hospitalsrms/index.php/Admin/Login/index" method="post">				
				        ...
				        <div class="form-group">
				          <div class="col-md-12">
				          	<div class="control-wrapper">
				          		<input type="submit" name="submit" value="登录"class="btn btn-info col-md-12">
