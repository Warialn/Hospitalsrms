...
<div class="contain">
 ...
 padding:5px 3px 0px 200px;">项目申报管理>课题申请</div>
<div class="col-md-10 column" style="background-color:#fff;height:550px;">
                    ...
                    <form name="form2" method="get" action="">
                        <table class="table  table-striped table-bordered table-hover"><br/>
                            ...
                            <div class="col-md-2 pull-right">
                                <input class="form-control" type="text" placeholder="课题名称" name="name"/>
                            </div>
                            <br/><br/>
    ...
    //alert(check);
    $.ajax({
        url:'/test/Hospitalsrms/index.php/Admin/Xmsb/index_delAll',
        type:'post',
        data:data,
        dataType:'JSON',
        success:function(data){
