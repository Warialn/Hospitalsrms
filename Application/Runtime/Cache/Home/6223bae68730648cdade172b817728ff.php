				...
				<div class="col-md-3 column">
					...
					<div class="col-md-12 column">
						<div class="panel-group" id="panel-851664">
							<div class="panel panel-default">
								<ul class="nav nav-pills nav-stacked">
									<li class="active"><a href="<?php echo U('Xshd/scanMeet');?>">会议</a></li>
...
<script>
	function look(){
	    document.form1.action="/Hospitalsrms/index.php/Home/Xshd/scanTheses";
	}
	function mod(){
	...
	if(v==0){
		...
		document.form2.action="/Hospitalsrms/index.php/Home/Xshd/deleteAll";
	}else if(v==1){
		document.form2.method="get";
		document.form2.action="/Hospitalsrms/index.php/Home/Xshd/updatefile";
	}else{
		document.form2.method="get";
		document.form2.action="/Hospitalsrms/index.php/Home/Xshd/export";
	}
	form2.submit();
}
