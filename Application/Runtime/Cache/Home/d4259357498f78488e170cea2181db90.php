...
<div class="container">
	...
	<div class="row clearfix">
				...
				<div class="panel-group" id="panel-851664">
					<div class="panel panel-default">
						<ul class="nav nav-pills nav-stacked">
							...
							<li class="active"><a href="<?php echo U('Xshd/addComposition');?>">学术著作</a></li>					
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="panel-group" id="panel-851664">
					<div class="panel panel-default">
						<ul class="nav nav-pills nav-stacked">
							...
							<li><a href="<?php echo U('Xshd/scanLecture');?>">讲座</a></li>
		...
		<div class="col-md-8" style="background-color:#f8f8f8;border-radius:6px;border:1px solid #e8e8e8;margin-right:30px;">
			<form role="form" style="padding-top:15px;" action="http://localhost/test/Hospitalsrms/index.php/Home/Xshd/addComposition" method="post" name="myform" onsubmit="return CheckPost();">
				...
				<table width="795" height="287"  class="table">
					<tr>
					<td width="246">著作名称（<span class="fontStar">※</span>）</td>
					<td width="533"><input type="text" class="form-control input-sm" id="name1" placeholder="" name="compositionName"></td>
					</tr>
					<tr>
					<td>作者（<span class="fontStar">※</span>）</td>
					<td><input type="text" class="form-control input-sm" id="name2" placeholder="" name="author"></td>
					</tr>
					<tr>
					<td>关键字（<span class="fontStar">※</span>）</td>
					...
					<tr>
					<td>所属领域</td>
					<td><input type="text" class="form-control input-sm" id="num" name="field"></td>
					</tr>
					<tr>
					<td>简介</td>
					<td><textarea class="form-control input-sm" id="num" name="introduction"></textarea></td>
					</tr>					
					<tr>
						<td colspan="2"><br/>
							<span class="col-lg-6">
