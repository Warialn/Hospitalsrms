...
<div class="container">
	...
	<div class="row clearfix">
				...
				<div class="panel-group" id="panel-851664">
					<div class="panel panel-default">
						<ul class="nav nav-pills nav-stacked">
							<li class="active"><a href="<?php echo U('Kyjf/index');?>">经费报销</a></li>
		...
		<div class="col-md-8" style="background-color:#f8f8f8;border-radius:6px;border:1px solid #e8e8e8;margin-right:30px;">
			<form role="form" enctype="multipart/form-data" style="padding-top:15px;" action="http://localhost/test/Hospitalsrms/index.php/Home/Kyjf/index" method="post" name="myform" onsubmit="return CheckPost();">
				...
				<table width="795" height="287"  class="table">
					...
					<td width="533"><input type="text" class="form-control input-sm" id="name1" placeholder="" name="where"></td>
					</tr>
					<tr>
					<td>金额（<span class="fontStar">※</span>）（单位：元）</td>
					<td><input type="text" class="form-control input-sm" id="name2" placeholder="" name="money"></td>
					</tr>
					<tr>
					<td>所属项目</td>
					...
					<td><input type="text" name="time" class="form-control input-sm" value="" id="datetimepicker"/></td>
					</tr>
					<tr>
					<td>类型</td>
					<td><input type="text" class="form-control input-sm" id="num" name="type"></td>
					</tr>
