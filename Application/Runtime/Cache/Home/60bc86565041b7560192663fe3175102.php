	        ...
	        <div class="col-sm-12">
	            <div class="row">
	                <div class="col-xs-win">             
	                    <form id="coller_edit_form" method="post" class="form-horizontal" role="form">
						...
						<div class="panel-group" id="panel-851664">
							<div class="panel panel-default">
								<ul class="nav nav-pills nav-stacked">
									...
									<li class="active"><a href="<?php echo U('Xmsb/scanColler');?>">领用情况</a></li>
				...
				<div class="col-md-8 column" style="background-color:#f8f8f8;border-radius:6px;border:1px solid #e8e8e8;">
					<form name="form2" method="post" action="">
						<div class="form-group " style="margin-top:20px;">
							...
							<input class="form-control col-sm-3 pull-right" name="starname" type="text" style="width:85px;"placeholder="物品名称" />
...
$(".closePop").css('cusor','pointer').click(function(){
 ...
 $('.delete').click(function(){
    ...
    $.ajax({
    	url:'/test/Hospitalsrms/index.php/Home/Xmsb/coller_delete',
    	type:'post',
    	data:{'id':id},
    	dataType:'json',
    	success:function(data){
