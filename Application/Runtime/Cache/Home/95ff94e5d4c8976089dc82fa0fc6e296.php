...
<div class="container">
	...
	<div class="row clearfix">
				...
				<div class="panel-group" id="panel-851664">
					<div class="panel panel-default">
						<ul class="nav nav-pills nav-stacked">
							...
							<li class="active"><a href="<?php echo U('Xmsb/coller');?>">领用申请</a></li>
		...
		<div class="col-md-8" style="background-color:#f8f8f8;border-radius:6px;border:1px solid #e8e8e8;margin-right:30px;">
			<form role="form" style="padding-top:15px;" action="http://localhost/test/Hospitalsrms/index.php/Home/Xmsb/coller" method="post" name="myform" onsubmit="return CheckPost();">
				...
				<table width="795" height="287" class="table">
				  <tr>
				    <td width="178">物品名称（<span class="fontStar">※</span>必填）</td>
				  ...
				  <tr>
				    <td>部门（<span class="fontStar">※</span>）</span></td>
				  ...
				  <tr>
				    ...
				    <td><input type="text" class="form-control input-sm" id="name2" placeholder="" name="price"></td>
				  </tr>
				  
				  <tr>
				    <td>数量（<span class="fontStar">※</span>） </td>
				    <td> <input type="text" class="form-control input-sm" id="name4" placeholder="" name="num"></td>
				  </tr>
				  <tr>
				    <td>领用人（<span class="fontStar">※</span>）</td>
				    <td><input type="text" class="form-control input-sm" id="num" name="user"></td>
				  </tr>
				   <tr>
				    <td>联系方式（<span class="fontStar">※</span>）</td>
				    <td><input type="text" class="form-control input-sm" id="num" name="contact"></td>
				  </tr>
				   <tr>
				    <td>领用事由（<span class="fontStar">※</span>）</td>
