				...
				<div class="col-md-8 column" style="background-color:#f8f8f8;border-radius:6px;border:1px solid #e8e8e8;">
					<form name="form2" method="get" action="">
						<div class="form-group " style="margin-top:20px;">
							...
							<input class="form-control col-sm-3 pull-right" name="name" type="text" style="width:85px;"placeholder="课题名称" />
...
$(".closePop").css('cusor','pointer').click(function(){
 ...
 $('.delete').click(function(){
  ...
  $(".delAll").click(function(){
	...
	$.ajax({
		url:'/test/Hospitalsrms/index.php/Home/Xmsb/subject_delAll',
		type:'post',
		data:data,
		dataType:'JSON',
		success:function(data){
