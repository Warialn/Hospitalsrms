...
<div class="container">
	<div id="modal-overlay" class="editIndex">
	        ...
	        <div class="col-sm-12">
	            <div class="row">
	                <div class="col-xs-win">             
	                    <form id="index_edit_form" method="post" class="form-horizontal" role="form">

	                        <div class="form-group">
	                            <label class="col-sm-3 control-label no-padding-right"> 报销人: </label>
	                            <div class="col-sm-6">
	                        ...
	                        <div class="space-4"></div>
	                         <div class="form-group">
	                            <label class="col-sm-3 control-label no-padding-right"> 依托课题编号: </label>
	                            <div class="col-sm-6">
...
$(".closePop").css('cusor','pointer').click(function(){
 ...
 $(".edit").click(function () {
        ...
        $('#edit_id').val(id);
        $("#index_edit_form #user").val(row.children('td:eq(1)').html());
        $("#index_edit_form #subject_id").val(row.children('td:eq(2)').html());
        $("#index_edit_form #money").val(row.children('td:eq(3)').html());
        $("#index_edit_form #datetimepicker").val(row.children('td:eq(4)').html());
        

        //return false
    });
 $("#index_edit_form").submit(function(e){
 		e.stopPropagation();
        e.preventDefault();
        var editIndex_data = $('#index_edit_form').serialize();
        console.log(editIndex_data);
         $.ajax({
            url:'/test/Hospitalsrms/index.php/Home/Kyjf/index_edit',
            type:'POST',
            dataType:'json',
            data:editIndex_data,
 ...
 $('.delete').click(function(){
    ...
    $.ajax({
    	url:'/test/Hospitalsrms/index.php/Home/Kyjf/index_delete',
    	type:'post',
    	data:{'id':id},
    	dataType:'json',
    	success:function(data){
 ...
 $(".delAll").click(function(){
	...
	$.ajax({
		url:'/test/Hospitalsrms/index.php/Home/Kyjf/index_delAll',
		type:'post',
		data:data,
		dataType:'JSON',
		success:function(data){
