...
<div class="container">
	...
	<div class="row clearfix">
				...
				<div class="panel-group" id="panel-851664">
					<div class="panel panel-default">
						<ul class="nav nav-pills nav-stacked">
							...
							<li class="active"><a href="<?php echo U('Xmsb/purchase');?>">采购申请</a></li>
		...
		<div class="col-md-8" style="background-color:#f8f8f8;border-radius:6px;border:1px solid #e8e8e8;margin-right:30px;">
			<form role="form" style="padding-top:15px;" action="http://localhost/test/Hospitalsrms/index.php/Home/Xmsb/purchase" method="post" name="myform" onsubmit="return CheckPost();">
				...
				<table width="795" height="287" class="table">
				  <tr>
				    <td width="178">物资名称（<span class="fontStar">※</span>必填）</td>
				    <td width="601"><input type="text" class="form-control input-sm" id="name1" placeholder="" name="name"></td>
				  </tr>
				  <tr>
				    <td>规格型号（<span class="fontStar">※</span>）</span></td>
				    <td> <input type="text" class="form-control input-sm" id="name2" placeholder="" name="type"></td>
				  </tr>
				  <tr>
				    <td>单价（<span class="fontStar">※</span> 单位：元）</td>
				    <td> <input type="text" class="form-control input-sm" id="name3" placeholder="" name="price"></td>
				  </tr>
				  <tr>
				    <td>数量（<span class="fontStar">※</span>）</td>
				    <td><input type="text" class="form-control input-sm" id="name2" placeholder="" name="num"></td>
				  </tr>				  
				  <tr>
				    <td>总价 （<span class="fontStar">※</span> 单位：元）</td>
				    <td> <input type="text" class="form-control input-sm" id="name4" placeholder="" name="total"></td>
				  </tr>
				  <tr>
				    <td>日期</td>
				    <td><input type="text" value="2017/01/22 08:00" class="form-control input-sm" name="date" id="datetimepicker"/></td>
				  </tr>
				   <tr>
				    <td>申请人</td>
				    <td><input type="text" class="form-control input-sm" id="num" name="applicant"></td>
				  </tr>
				   <tr>
				    <td>所属平台</td>
				    <td><input type="text" class="form-control input-sm" id="num" name="department"></td>
				  </tr>
				   <tr>
				    <td>申请原因</td>
				    <td> <input type="text" class="form-control input-sm" id="num" name="reason"></td>
				  </tr>
				    <td colspan="2"><br/>
				    	<span class="col-lg-6">
