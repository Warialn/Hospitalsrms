...
<div class="container">
	<div id="modal-overlay" class="editApply">
	        ...
	        <div class="col-sm-12">
	            <div class="row">
	                <div class="col-xs-win">             
	                    <form id="apply_edit_form" method="post" class="form-horizontal" role="form">
	                        ...
	                        <div class="form-group">
	                         ...
	                         <div class="form-group">
	                            <label class="col-sm-3 control-label no-padding-right"> 依托课题: </label>
	                            <div class="col-sm-6">
	                        ...
	                        <div class="space-4"></div>
	                         <div class="form-group">
	                            ...
	                            <div class="col-sm-6">
	                                <input type="text" name="time" id="datetimepicker" class="form-control"/>
	                            </div>
	                        </div>
		...
		<div class="col-md-3 column">
			...
			<div class="col-md-12 column">
				<div class="panel-group" id="panel-851664">
					<div class="panel panel-default">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="<?php echo U('Kyjf/scanIndex');?>">经费报销</a></li>
							<li class="active"><a href="<?php echo U('Kyjf/scanApply');?>">经费申请</a></li>
						</ul>
					</div>
				</div>
			</div>
...
$(".closePop").css('cusor','pointer').click(function(){
 ...
 $(".edit").click(function () {
        ...
        $('#edit_id').val(id);
        $("#apply_edit_form #user").val(row.children('td:eq(1)').html());
        $("#apply_edit_form #subject_id").val(row.children('td:eq(2)').html());
        $("#apply_edit_form #money").val(row.children('td:eq(3)').html());
        $("#apply_edit_form #datetimepicker").val(row.children('td:eq(4)').html());

        

        //return false
    });
 $("#apply_edit_form").submit(function(e){
 		e.stopPropagation();
        e.preventDefault();
        var editApply_data = $('#apply_edit_form').serialize();
        console.log(editApply_data);
         $.ajax({
            url:'/test/Hospitalsrms/index.php/Home/Kyjf/apply_edit',
            type:'POST',
            dataType:'json',
            data:editApply_data,
 ...
 $('.delete').click(function(){
    ...
    $.ajax({
    	url:'/test/Hospitalsrms/index.php/Home/Kyjf/apply_delete',
    	type:'post',
    	data:{'id':id},
    	dataType:'json',
    	success:function(data){
