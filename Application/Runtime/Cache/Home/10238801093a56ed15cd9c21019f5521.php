						...
						<div class="panel-group" id="panel-851664">
							<div class="panel panel-default">
								<ul class="nav nav-pills nav-stacked">
									...
									<li class="active"><a href="<?php echo U('Xmsb/scanPurchase');?>">采购申请进展</a></li>
								</ul>
							</div>
						</div>
					</div>
...
$(".closePop").css('cusor','pointer').click(function(){
 ...
 $("#purchase_edit_form").submit(function(e){
        ...
        console.log(editSubject_data);
         $.ajax({
            url:'/test/Hospitalsrms/index.php/Home/Xmsb/purchase_edit',
            type:'POST',
            dataType:'json',
 ...
 $('.delete').click(function(){
    ...
    $.ajax({
    	url:'/test/Hospitalsrms/index.php/Home/Xmsb/purchase_delete',
    	type:'post',
    	data:{'id':id},
    	dataType:'json',
    	success:function(data){
   ...
   $(".delAll").click(function(){
	...
	$.ajax({
		url:'/test/Hospitalsrms/index.php/Home/Xmsb/purchase_delAll',
		type:'post',
		data:data,
		dataType:'JSON',
		success:function(data){
