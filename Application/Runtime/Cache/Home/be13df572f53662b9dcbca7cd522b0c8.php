						...
						<div class="panel-group" id="panel-851664">
							<div class="panel panel-default">
								<ul class="nav nav-pills nav-stacked">
									...
									<li class="active"><a href="<?php echo U('Kytj/scanAchievement');?>">科研成果</a></li>
				...
				<div class="col-md-8 column" style="background-color:#f8f8f8;border-radius:6px;border:1px solid #e8e8e8;">
					<form name="form2" method="post" action="">
						<div class="form-group " style="margin-top:20px;">
							...
							<input class="form-control col-sm-3 pull-right" name="starname" type="text" style="width:85px;"placeholder="成果名称" />
