...
<div class="container">
	...
	<div class="row clearfix">
				...
				<div class="panel-group" id="panel-851664">
					<div class="panel panel-default">
						<ul class="nav nav-pills nav-stacked">
							...
							<li class="active"><a href="<?php echo U('Kyjf/moneyApply');?>">经费申请</a></li>								
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="col-md-8" style="background-color:#f8f8f8;border-radius:6px;border:1px solid #e8e8e8;margin-right:30px;">
			<form role="form" style="padding-top:15px;" action="http://localhost/test/Hospitalsrms/index.php/Home/Kyjf/moneyApply" method="post" name="myform" onsubmit="return CheckPost();">
				...
				<table width="795" height="287"  class="table">
					<tr>
					<td>申请人（<span class="fontStar">※</span>）</td>
